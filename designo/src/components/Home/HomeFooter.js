...
export default function HomeFooter() {
  return (
    <div className='w-full h-[815px] bg-myBlack -mt-52 relative flex flex-col items-center'>
        <div className='contentFooter w-4/5 absolute top-72 flex flex-col items-center z-50'>
            <img src={logoLight} className="w-52" alt='logoLight'></img>
            <hr className='w-full border-myDarkGrey mt-8'/>

            <div className='links h-28 flex flex-col items-center justify-between mt-8 text-myWhite text-sm font-normal tracking-wide uppercase'>
