...
export default function HomeFooter() {
  return (
    <div className='w-full h-[815px] bg-myBlack -mt-52 relative flex flex-col items-center md:h-[600px]'>
        <div className='contentFooter w-4/5 absolute top-72 flex flex-col items-center z-50 md:w-11/12'>
            <div className='w-full flex flex-col items-center md:flex-row md:relative md:justify-between'>
                <img src={logoLight} className="w-52" alt='logoLight'></img>
                <hr className='w-full border-myDarkGrey mt-8 md:absolute md:bottom-0'/>

                <div className='links h-28 flex flex-col items-center justify-between mt-8 text-myWhite text-sm font-normal tracking-wide uppercase md:flex-row md:w-[370px] md:justify-between md:mt-0'>
            ...
            <div className='md:w-full md:flex md:justify-between items-end'>
            <div className='visitUs mt-10 text-myDarkGrey text-base flex flex-col items-center'>
                <h5 className='font-bold'>Designo Central Office</h5>
                <p>3886 Wellington Street</p>
                <p>Toronto, Ontario M9C 3J5</p>
            </div>

            <div className='contact mt-10 text-myDarkGrey text-base flex flex-col items-center'>
                <h5 className='font-bold'>Contact Us (Central Office)</h5>
                <p>P : +1 253-863-8967</p>
                <p>M : contact@designo.co</p>
            </div>

            <div className='social w-48 mt-8 flex justify-between'>
