...
export default function Home(props) {
  return (
    <div className='md:flex md:justify-center'>
        <div className='bg-peach flex flex-col items-center text-myWhite text-center md:w-11/12 md:rounded-2xl'>
            {
                props.button ?
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="640" height="640" className='absolute left-0 w-fit md:left-1/4 rotate-45'><defs><linearGradient id="a" x1="0%" x2="100%" y1="50%" y2="50%"><stop offset="0%" stopColor="#5D0202" stopOpacity="0"/><stop offset="100%" stopColor="#5D0202" stopOpacity=".498"/></linearGradient></defs><circle cx="320" cy="320" r="320" fill="url(#a)" fillRule="evenodd" opacity=".203" transform="matrix(-1 0 0 1 640 0)"/></svg>
                <h2 className='font-medium text-2xl md:text-5xl'>Award-winning custom designs and digital branding solutions</h2>

                <p className='mt-4 w-[445px]'>
